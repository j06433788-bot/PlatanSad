...
const ReturnPage = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content - Адаптовано */}
      <div className="max-w-7xl mx-auto px-4 py-6 md:py-12">
        {/* Return Policy - Адаптовано */}
        <div className="bg-white rounded-lg md:rounded-2xl shadow-lg p-5 md:p-10 mb-6 md:mb-10">
        ...
        {/* Conditions Grid - Адаптовано */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-10">
          {/* Можна повернути */}
          <div className="bg-white rounded-lg md:rounded-2xl shadow-lg p-5 md:p-8">
            <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
            ...
            <ul className="space-y-2 md:space-y-3 text-gray-600">
              <li className="flex items-start gap-2 md:gap-3">
                <span className="text-green-500 text-lg md:text-xl mt-0.5 md:mt-1">✓</span>
          ...
          <div className="bg-white rounded-lg md:rounded-2xl shadow-lg p-5 md:p-8">
            ...
            <ul className="space-y-2 md:space-y-3 text-gray-600">
              <li className="flex items-start gap-2 md:gap-3">
                <span className="text-red-500 text-lg md:text-xl mt-0.5 md:mt-1">✗</span>
        ...
        <div className="bg-white rounded-lg md:rounded-2xl shadow-lg p-5 md:p-10 mb-6 md:mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <div className="text-center" data-testid="return-step">
              ...
              <h4 className="font-bold text-gray-800 mb-2 text-sm md:text-base">Зв'яжіться з нами</h4>
            ...
            <div className="text-center" data-testid="return-step">
              ...
              <h4 className="font-bold text-gray-800 mb-2 text-sm md:text-base">Відправте товар</h4>
            ...
            <div className="text-center" data-testid="return-step">
              ...
              <h4 className="font-bold text-gray-800 mb-2 text-sm md:text-base">Перевірка</h4>
              <p className="text-xs md:text-sm text-gray-600">Ми перевіримо стан товару після отримання</p>
            </div>

            <div className="text-center" data-testid="return-step">
              <div className="bg-green-100 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
                <span className="text-xl md:text-2xl font-bold text-green-600">4</span>
              </div>
              <h4 className="font-bold text-gray-800 mb-2 text-sm md:text-base">Повернення коштів</h4>
              <p className="text-xs md:text-sm text-gray-600">Гроші повернуться протягом 3-5 робочих днів</p>
            </div>
          </div>
        </div>

        {/* Contact Info - Адаптовано */}
        <div className="bg-green-50 border-2 border-green-200 rounded-lg md:rounded-2xl p-5 md:p-8">
          <h3 className="text-lg md:text-2xl font-bold text-gray-800 mb-3 md:mb-4">Потрібна консультація?</h3>
